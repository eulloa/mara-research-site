...
export const News = () => {
  const toggle = (section: string) => {
    // find all list items in ul.news
    const listItems = document.querySelectorAll(`.news li.${section}`);

    // first check the section
    // - if it does not have hidden, skip and don't toggle
    let skip = false;
    ...
    // add hidden to all other list items
    const remainingListItems = document.querySelectorAll(
      `.news li:not(.${section}`
    );
          ...
          <ul className="news space-y-4">
            ...
            <li className="papers">
              ...
              <a
                ...
                target="_blank"
              >
                Supporting User Engagement in Testing, Auditing, and Contesting
                AI
              </a>{" "}
              in Minneapolis, MN
            </li>
            ...
            <li className="updates hidden">
              &#128105;&#127995;&#8205;&#127979; 09/2021 Started my PhD studies
              in CS at{" "}
              <a
                className="underline"
            ...
            <li className="updates hidden">
              &#128105;&#127995;&#8205;&#127979; 10/2019 Attended and presented
              at the{" "}
              <a
                className="underline"
