...
export const News = () => {
  const toggle = (section: string): void => {
    ...
    if (newsSection?.classList.contains("hidden")) {
      newsSection.classList.remove("hidden");

      const sections = document.querySelectorAll(".news-section");
      sections?.forEach((s) => {
        if (s.classList.contains(section)) return;
  ...
  return (
    <div className="mt-10" id="news">
      ...
      <div className="bg-lightBlue dark:bg-black rounded-lg rounded-e-lg h-[400px] overflow-y-scroll">
        <div className="terminal-header rounded-t-lg bg-darkBlue dark:bg-[#2d2c29] flex gap-x-3 sticky top-0 z-10 p-2">
          <div className="buttons flex flex-0">
        ...
        <div className="content p-6 dark:text-white leading-8">
          <div className={["news-section", "papers", "space-y-2"].join(" ")}>
            <ul className="space-y-4">
              <li>
                &#128105;&#127995;&#8205;&#127979; 06/2024 Presented ongoing
                research on the design of patient-facing machine learning (ML)
                at{" "}
                <a
                  className="underline"
                  ...
                  target="_blank"
                >
                  The International Society for Research on Internet
                  Interventions (ISRII)
                </a>{" "}
                in Limerick, Ireland
              </li>
              <li>
                ...
                <a
                  ...
                  target="_blank"
                >
                  The National Science Foundation&apos;s (NSF) National Center
              ...
              <li>
                ...
                <a
                  ...
                  target="_blank"
                >
                  The Graduate Engagement Opportunities (GEO) Community
                  Practicum
                </a>
              </li>
              <li>
              ...
              <li>
                ...
                <a
                  ...
                  target="_blank"
                >
                  Supporting User Engagement in Testing, Auditing, and
                  Contesting AI
                </a>{" "}
                in Minneapolis, MN
              </li>
              ...
              <li>
                ...
                <a
                  ...
                  target="_blank"
                >
                  Invisible Clinical Labor Driving the Successful Integration of
                  AI in Healthcare
                </a>
              </li>
              <li>
          ...
          <div className="hidden news-section updates space-y-2">
            <ul className="space-y-4">
              <li>
                &#127942; 09/2022 Awarded the{" "}
                <a
              ...
              <li>
                &#127891; 05/2021 Graduated with a Bachelor of Science (BS)
